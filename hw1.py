...
def main_menu():
    while True:
        ...
        if numb == 1:
            ...
            search_contact(input('Введите искомое фамилию/имя/отчество/номер телефона:'))
        elif numb == 3:
            add_contact(input('Для добавления нового пользователя введите ФИО и номер телефона:'))
        elif numb == 4:
            change_contact(input('Введите, что вы хотите изменить: '),input('На что необходимо изменить:'))     
        elif numb == 5:
